...
all_text = spark.textFile("C:/Users/Gianni/Programming/Data Science/P0/data/*.txt")
...
with open("C:/Users/Gianni/Programming/Data Science/P0/sp1.json", 'w+') as f:
...
stopwords = spark.textFile("C:/Users/Gianni/Programming/Data Science/P0/sw/stopwords.txt")
...
with open("C:/Users/Gianni/Programming/Data Science/P0/sp2.json", 'w+') as f:
...
with open("C:/Users/Gianni/Programming/Data Science/P0/sp3.json", 'w+') as f:
    json.dump(dict(top_counts), f, sort_keys=True, indent=4) 
...
"""sp4: gather document locations by looping through directory;
    *abuse* list comprehension to create an array of RDDs, one
    ...
    each document """
base_filepath = "C:/Users/Gianni/Programming/Data Science/P0/data/"
all_docs = []
...
with open("C:/Users/Gianni/Programming/Data Science/P0/sp4.json", 'w+') as f:
    combined_output = []
    for o in output:
        combined_output += o
